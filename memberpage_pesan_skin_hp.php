...
if(isset($_SESSION['id_user'])){
	...
	$lihat=mysql_query("select * from hp");
...
<section>
	...
	<div class="wl-main-content">
		...
		<div class="container">
			<div class="row" style="margin:10px">
				<form name="skin_hp" id="contactForm" action="proses_memberpage.php" method="post" enctype="multipart/form-data">
					<fieldset>
						...
						<div class="col-md-5 wl-rightfeature-boxes" style="width: 66%">
							...
							<label for="username"><h5>Jenis Handphone</h5></label><br>
							<select name="jenis_hp" style="width: 250px">
							  	<option value="">pilih jenis hp...</option>
							<?php
								while ($r=mysql_fetch_array($lihat)){ 
							?>
							  	<option value="<?php echo $r['id_hp'] ?>"><?php echo $r['nama_hp'] ?></option>
							<?php } ?>
							</select>
							<br>
							...
							<button type="submit" class="btn btn-primary col-md-11"  name="pesan_skin_hp">Proses pemesanan</button>
							<br><br><br>
						</div>
					</fieldset>
	...
	$konek="select * from pemesanan,hp where pemesanan.id_pemesanan=$id_pemesanan and pemesanan.id_hp=hp.id_hp";
	// echo $konek;
			...
			<div class="row" style="margin:10px">
				<form name="skin_hp" id="contactForm" action="proses_memberpage.php" method="post" enctype="multipart/form-data">
					<fieldset>
						<div class="col-md-5 wl-right-col">
							<div class="wl-overflow wl-relative hover-sibling-2">
								<img src="admin-web/gambar_pesanan/hp/<?php echo $baca['gambar_1'] ?>">
							</div>
							<div class="wl-standard-margin hover-sibling-1">
						...
						<div class="col-md-5 wl-rightfeature-boxes" style="width: 66%">
							...
							<label for="username"><h5>Jenis Handphone</h5></label><br>
							<select name="jenis_hp" style="width: 250px" <?php echo $readonly ?>>
							  	<option value="<?php echo $baca['id_hp'] ?>"><?php echo $baca['nama_hp'] ?></option>
							<?php
								while ($r=mysql_fetch_array($lihat)){ 
							?>
							  	<option value="<?php echo $r['id_hp'] ?>"><?php echo $r['nama_hp'] ?></option>
							...
							?>
							<button type="submit" class="btn btn-primary col-md-11"  name="update_pesan_skin_hp">Update pemesanan</button>
							<?php } else {} ?>
							<br><br><br>
						</div>
					</fieldset>
