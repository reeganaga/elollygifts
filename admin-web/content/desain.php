...
<div class="content container">
    ...
    <?php echo "<a href='index.php?module=tambahdesain' class='btn btn-info'>Tambahkan Kado</a>" ?>
    <br><br>
        ...
        <div class="body">
            <div class="mt">
                <table id="datatable-table" class="table table-striped table-hover">
                    ...
                    <?php
                    $no=1;
                    // $row=mysql_fetch_array($lihat_gambar);
                    while ($r=mysql_fetch_array($lihat_gambar)){
                        ...
                        echo"<tr>
                            ...
                            <div class='row margin-bottom text-align-center'>
                                <div class='col-md-12'>
                                    <div class='btn-group'>
                                        <a href='index.php?module=tambahdesain&id=$r[id_desain]' class='btn btn-info'>Edit</a>
                                        <a class='btn btn-warning' href=\"javascript: delet_desain('".$r['id_desain']."','".$r['nama']."')\">Delete</a>
                                    </div>
                                </div>
                            </div>
                            </td>
