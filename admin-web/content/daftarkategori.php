...
<div class="content container">
    <h2 class="page-title"> Kategori Elolly Gift</h2><br>
    <?php echo "<a href='index.php?module=tambahcategory' class='btn btn-info'>Tambahkan Kategori</a>" ?>
    <br><br>
                            ...
                            <div class='row margin-bottom text-align-center'>
                                <div class='col-md-12'>
                                    <div class='btn-group'>
                                        ...
                                        <a class='btn btn-warning' href=\"javascript: delet_product('".$r['id_category']."')\">Delete</a>
                                    </div>
                                </div>
                            </div>
                            </td>
