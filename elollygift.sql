...
--
-- Host: 127.0.0.1
-- Generation Time: 01 Apr 2018 pada 11.43
-- Versi Server: 5.5.36
-- PHP Version: 5.4.27
...
INSERT INTO `desain` (`id_desain`, `nama`, `harga`) VALUES
(2, 'edit', 150000);
...
CREATE TABLE IF NOT EXISTS `hp` (
  `id_hp` int(20) NOT NULL AUTO_INCREMENT,
  `nama_hp` varchar(30) NOT NULL,
  `id_category` int(20) NOT NULL,
  PRIMARY KEY (`id_hp`),
  UNIQUE KEY `nama_hp` (`nama_hp`)
...
--
-- Struktur dari tabel `kado`
--

CREATE TABLE IF NOT EXISTS `kado` (
  `id_kado` int(11) NOT NULL AUTO_INCREMENT,
  `nama_kado` varchar(255) NOT NULL,
...
--
-- Dumping data untuk tabel `kado`
--

INSERT INTO `kado` (`id_kado`, `nama_kado`, `ukuran`, `harga`) VALUES
(1, 'test', 'S', 12121),
(3, 'kado lagi edit', 'S edit', 150000);
...
CREATE TABLE IF NOT EXISTS `laptop` (
  `id_laptop` int(20) NOT NULL AUTO_INCREMENT,
  `nama_laptop` varchar(30) NOT NULL,
  `id_category` int(20) NOT NULL,
  PRIMARY KEY (`id_laptop`),
  UNIQUE KEY `nama_laptop` (`nama_laptop`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `motor` (
  `id_motor` int(20) NOT NULL AUTO_INCREMENT,
  `nama_motor` varchar(30) NOT NULL,
  `id_category` int(20) NOT NULL,
  PRIMARY KEY (`id_motor`),
  UNIQUE KEY `nama_motor` (`nama_motor`)
...
(5, 'rega', '39444744eb44843a6804d37ea223b3e1', '', NULL, '', '', NULL, '', 'rega.blank@gmail.com');
...
INSERT INTO `pemesanan` (`id_pemesanan`, `id_pelanggan`, `id_motor`, `id_hp`, `id_laptop`, `tanggal_pemesanan`, `gambar_1`, `gambar_2`, `id_konfirmasi`, `deskripsi_pemesanan`, `status_pemesanan`, `pesan_admin`, `id_kado`, `id_desain`) VALUES
(5, 3, 0, 2, 0, '2016-10-12', '14juni2013_960_057.jpg', 'konfirmasi-27034-Albert1.jpg', 12, 'asdasd\r\nasdas\r\nasdasdasdasgergr', 'gambar dikonfirmasi', 'dicoba kirim pesan hp coba script                                                                   ', 0, 0),
(8, 3, 2, NULL, NULL, '2016-10-12', 'Atmaja Basuki-5562images.jpg', 'konfirmasi-44947-adityaT.jpg', 12, 'warna dan tema mirip dengan heli kopter tersebut', 'gambar dikonfirmasi', 'coba kirim pesan                                            ', 0, 0),
(10, 3, 1, 0, 0, '2016-10-31', '2016-10-31-Atmaja Basuki-12731-9iz7ABpzT.png', '', 14, 'asdasdasdasdasd a', '', '', 0, 0),
(11, 3, 0, 0, 1, '2016-11-02', '2016-11-02-Atmaja Basuki-73700-il_570xN.747157845_nteu.jpg', '', 14, 'dsfdsfsdf a', '', '', 0, 0),
(12, 3, 0, 2, 0, '2016-11-02', '2016-11-02-Atmaja Basuki-63739-mobil.jpg', '', 14, 'afadasdsad a																					', '', '', 0, 0),
(13, 5, NULL, NULL, NULL, '2018-04-01', '2018-04-01--64803-thul-90efb785-97af-5e51-94cf-503fc81b6940.jpg', '', 0, 'deskripsi pemesanan', '', '', 1, 2);
